/*
  ...
  - Added the required column `review` to the `Hike` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Hike" ("createdAt", "date", "hikerId", "id", "imageUrl", "rating", "trailId", "updatedAt") SELECT "createdAt", "date", "hikerId", "id", "imageUrl", "rating", "trailId", "updatedAt" FROM "Hike";
DROP TABLE "Hike";
